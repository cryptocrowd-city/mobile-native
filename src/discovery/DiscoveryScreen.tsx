...
class DiscoveryScreen extends Component {
  ...
  render() {
    ...
    body = (
      <CollapsibleHeaderFlatList
        ...
        headerHeight={
          (GOOGLE_PLAY_STORE && discovery.filters.type !== 'channels') ||
          discovery.filters.type === 'lastchannels'
            ? 94
            : 144
        }
  ...
  getEmptyList() {
    if (
      !this.props.discovery.listStore.loaded ||
      this.props.discovery.listStore.loading ||
      this.props.discovery.listStore.errorLoading
    )
      return null;
    return (
  ...
  setTypeVideos = () => {
    if (
      ...
      this.props.discovery.filters.type === 'videos'
    ) {
  ...
  setTypeImages = () => {
    if (
      this.state.showFeed !== false &&
      this.props.discovery.filters.type === 'images'
    ) {
      return this.setState({ showFeed: false });
    }
  ...
  getHeaders() {
        ...
        <TouchableHighlight
          ...
          <View style={CS.columnAlignCenter}>
            ...
            <Text
              ...
              {i18n.t('discovery.all')}
            </Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.iconContainer}
          onPress={this.setTypeChannels}
          {...testID('Discovery Channels')}>
          <View style={CS.columnAlignCenter}>
            <Icon
              name="people"
              style={[
            ...
            <Text
              ...
              {i18n.t('discovery.channels')}
            </Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.iconContainer}
          onPress={this.setTypeVideos}
          {...testID('Discovery Videos')}>
          <View style={CS.columnAlignCenter}>
            <IonIcon
              name={
                this.state.showFeed !== false && filtersStore.type == 'videos'
                  ? 'md-apps'
                  : 'md-videocam'
              }
              style={[
            ...
            <Text
              ...
              {i18n.t('discovery.videos')}
            </Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.iconContainer}
          onPress={this.setTypeImages}
          {...testID('Discovery Images')}>
          <View style={CS.columnAlignCenter}>
            <IonIcon
              name={
                this.state.showFeed !== false && filtersStore.type == 'images'
                  ? 'md-apps'
                  : 'md-photos'
              }
              style={[
            ...
            <Text
              ...
              {i18n.t('discovery.images')}
            </Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.iconContainer}
          onPress={this.setTypeBlogs}
          {...testID('Discovery Blogs')}>
          <View style={CS.columnAlignCenter}>
            <Icon
              name="subject"
              style={[
            ...
            <Text
              ...
              {i18n.t('discovery.blogs')}
            </Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.iconContainer}
          onPress={this.setTypeGroups}
          {...testID('Discovery Groups')}>
          <View style={CS.columnAlignCenter}>
            <Icon
              name="group-work"
              style={[
    ...
    const iconRight = filtersStore.searchtext ? (
      ...
      <Text
        numberOfLines={1}
        style={styles.lastVisited}
        onPress={this.showLastChannels}>
        {i18n.t('discovery.visited')}
      </Text>
    ) : null;
    ...
    const headerBody =
      filtersStore.type != 'lastchannels' ? (
        <View style={[ThemedStyles.style.backgroundSecondary]}>
          ...
          <DiscoveryFilters
            store={filtersStore}
            onTagsChange={this.onTagSelectionChange}
        ...
        <Text
          ...
          {i18n.t('discovery.recentlyVisited')}
        </Text>
      );
   ...
   */
  refresh = async () => {
    if (this.props.discovery.filters.type == 'lastchannels') return;
  ...
  navigateToFeed = ({ urn }) => {
    ...
    this.props.navigation.push('DiscoveryFeed', {
      showFeed: index,
      title:
        _.capitalize(this.props.discovery.filters.filter) +
        ' ' +
        _.capitalize(this.props.discovery.filters.type),
    });
  };
  ...
  renderTile = (row) => {
    ...
    return (
      <ErrorBoundary
        message={this.tileError}
        containerStyle={[
          CS.centered,
          { width: this.state.itemHeight, height: this.state.itemHeight },
        ]}
        textSmall={true}>
        <DiscoveryTile
          entity={row.item}
    ...
    return (
      <ErrorBoundary containerStyle={CS.hairLineBottom}>
        <DiscoveryUser
          row={row}
          navigation={this.props.navigation}
          hideButtons={this.props.discovery.filters.type == 'lastchannels'}
        />
      </ErrorBoundary>
    );
  };
